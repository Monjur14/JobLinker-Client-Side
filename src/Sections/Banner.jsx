...
const Banner = () => {
  ...
  return (
    <div className="w-full min-h-screen lg:h-screen bg-gradient relative ">
        <img src="/src/assets/images/bgpattern.png" alt=""  className="absolute w-full h-full"/>
      <div className="contain flex gap-5 h-full z-20 flex-col lg:flex-row items-center px-2 md:px-3 lg:px-0">
        <div className="basis-1/2 mb-20 z-20 mt-14 md:mt-20 lg:mt-0">
            <h4 className="text-xl font-semibold text-indigo-800"  data-aos="zoom-in-right">We Have 300,000+ Live Jobs</h4>
            <h1 data-aos="zoom-in-up" className="text-[3.8rem] lg:text-[4.3rem] 2xl:text-[5rem] leading-[4rem] lg:leading-[5.5rem] font-semibold mt-1 lg:mt-0">Your <span className="text-indigo-800">Dream</span> Job Is Waiting for You</h1>
            <div className="w-[90%] gap-2 2xl:gap-10 md:mt-20 2xl:mt-28 hidden md:flex">
