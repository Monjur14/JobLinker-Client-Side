...
const Login = () => {
  ...
  return (
	...
	<div className="my-6 space-y-4">
		...
		<button aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1" onClick={() => githubLogin()}>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
	...
	<form noValidate="" action="" className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
		...
		<button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-indigo-700 text-white">Sign in</button>
	</form>
