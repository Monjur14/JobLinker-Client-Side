...
const Sponsors = () => {
  ...
  return (
    <div>
        <div className='contain flex justify-between items-center py-20'>
    ...
    <div className='w-full h-[500px] bg-last'>
        <div className='contain flex flex-col justify-center h-full text-white'>
            <h1 data-aos="zoom-out" className='text-2xl'>Our Community</h1>
            <h1 data-aos="fade-up" className='text-[3rem] max-w-[700px] 2xl:max-w-[800px] 2xl:text-[3.5rem] leading-tight mt-4 font-semibold'>Join our community of talented and professionals by applying for a job today!.</h1>
        </div>
    </div>
    </div>
  )
