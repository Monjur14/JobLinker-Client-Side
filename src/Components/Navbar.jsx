...
const Navbar = () => {
  ...
  return (
    ...
    <div className="contain flex justify-between items-center py-2 lg:py-3 px-3 2xl:py-4 lg:px-0">
      ...
      <img src="/src/assets/images/logo.png" alt="" className="w-44 2xl:w-48"/>
      </Link>
